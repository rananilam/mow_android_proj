...
object PaymentsUtil {
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (PaymentConstants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
                (PaymentConstants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(PaymentConstants.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
